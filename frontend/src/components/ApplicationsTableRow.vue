  ...
  <tr class="hover:bg-base-300 text-center">
    <td v-if="auth.isShelterStaff">
      <div class="flex items-center justify-center gap-3">
        ...
        <div>
          <div class="font-normal text-xl font-fredoka text-base-conten">{{ props.userName }}</div>
        </div>
      </div>
    </td>
    <td>
      ...
      >
        ...
        <div>
          <div class="font-normal text-xl font-fredoka text-base-content">{{ props.petName }}</div>
          <div class="text-base opacity-75 font-fredoka text-base-content">
            {{ props.shelterName }}
          </div>
        </div>
      </RouterLink>
    ...
    <td class="text-xl font-medium px-2">
      <div class="flex flex-col font-normal font-fredoka text-base-content">
        <p>{{ date }}</p>
        <p>{{ time }}</p>
      </div>
    </td>
    <td class="text-xl font-normal px-2 font-fredoka text-base-content">{{ props.status }}</td>
    <td class="px-0" v-if="auth.isShelterStaff">
      <RouterLink
        ...
        ><svg
          ...
          fill="currentColor"
          class="w-8 h-8 transition-transform duration-200 hover:scale-[1.25] text-accent dark:text-base-content"
        >
          <path
