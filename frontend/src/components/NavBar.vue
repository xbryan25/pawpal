  ...
  <nav class="h-screen w-[13vw] bg-[#f2f2f2] dark:bg-[#434343]">
    <div class="h-screen flex flex-col items-center justify-between">
      <div class="h-[10vh] w-full bg-[#D9D9D9] flex items-center justify-center">
        <h2 class="font-rethink font-extrabold text-3xl">PawPal</h2>
      </div>
      ...
      <div class="flex-1 w-full bg-[#AAAAAA]">
        <div class="mx-5 my-10 flex flex-col gap-3">
          <div class="flex gap-2">
            ...
            <RouterLink class="font-fredoka font-medium text-xl" to="/pets/view">Pets</RouterLink>
          </div>
          ...
          <div class="flex gap-2">
            ...
            <RouterLink class="font-fredoka font-medium text-xl" to="/applications/view"
          ...
          <div class="flex gap-2">
            ...
            <RouterLink class="font-fredoka font-medium text-xl" to="/reports/user/view"
              >Reports</RouterLink
            >
          </div>
        </div>
      ...
      <div ref="dropdownRef" class="relative h-[10vh] w-full bg-[#D9D9D9] flex items-center">
        <div class="mx-2 w-full flex cursor-pointer gap-3" @click="toggleDropdown">
          ...
          <div class="w-full h-15 flex flex-col justify-center">
            <p class="font-fredoka font-semibold max-h-5 text-sm">Bryan Agan</p>
            <p class="max-h-5 font-fredoka text-sm">Adopter</p>
          </div>
        </div>
